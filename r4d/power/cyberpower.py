...
load (os.path.join (mibpath, "CPSMIB2019.mib"))
def register (parent):
    log.debug ("register " + __name__)
    parent._add_model ('cyberpower', cyberpower)

class cyberpower (PowerControl):
    __mapper_args__ = {'polymorphic_identity': 'cyberpower'}
